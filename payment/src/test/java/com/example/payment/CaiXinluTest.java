...
//    }
    ...
    public void changeFreightModel1() throws Exception {
        ...
        byte[] responseString =
                manageClient.put().uri("payment/shops/{shopId}/freightmodels/{id}", 295, 88888)
                        .header("authorization", token)
    ...
    public void changeFreightModel3() throws Exception {
        ...
        byte[] responseString =
                manageClient.put().uri("payment/shops/{shopId}/freightmodels/{id}", 295, 99999)
                        .header("authorization", token)
                        .bodyValue(freightJson)
                        .exchange()
                        .expectBody()
    ...
    public void changePieceFreightModel1() throws Exception {
        ...
        String freightJson = "{\n" +
                ...
                "}";
        byte[] responseString =
                manageClient.put().uri("payment/shops/{shopId}/pieceItems/{id}", 295, 55555)
                        .header("authorization", token)
                        .bodyValue(freightJson)
                        .exchange()
                        .expectStatus().isOk()
    ...
    public void changeWeightFreightModel1() throws Exception {
        ...
        String freightJson = "{\n" +
                ...
                "}";
        byte[] responseString =
                manageClient.put().uri("payment/shops/{shopId}/weightItems/{id}", 295, 55555)
                        .header("authorization", token)
                        .bodyValue(freightJson)
                        .exchange()
                        .expectStatus().isOk()
    ...
    public void getOrderState() throws Exception {
        String token = this.userLogin("8606245097", "123456");
        byte[] responseString =
                mallClient.get().uri("payment/orders/states")
                        .header("authorization", token)
                        .exchange()
                        .expectStatus().isOk()
                        .expectBody()
    ...
    public void getOrders1() throws Exception {
        String token = this.userLogin("8606245097", "123456");
        byte[] responseString =
                mallClient.get().uri("payment/orders?orderSn=2016102322523&page=1&pageSize=5")
                        .header("authorization", token)
                        .exchange()
                        .expectStatus().isOk()
                        .expectBody()
    ...
    public void getOrders2() throws Exception {
        String token = this.userLogin("8606245097", "123456");
        byte[] responseString =
                mallClient.get().uri("payment/orders?page=1&pageSize=5&beginTime=2020-11-24 18:40:20")
                        .header("authorization", token)
                        .exchange()
                        .expectStatus().isOk()
                        .expectBody()
    ...
    public void getOrders3() throws Exception {
        String token = this.userLogin("8606245097", "123456");
        byte[] responseString =
                mallClient.get().uri("payment/orders?page=1&endTime=2021-11-23 18:40:20&pageSize=5")
                        .header("authorization", token)
                        .exchange()
                        .expectStatus().isOk()
                        .expectBody()
    ...
    public void getOrders4() throws Exception {
        String token = this.userLogin("8606245097", "123456");
        byte[] responseString =
                mallClient.get().uri("payment/orders?page=1&endTime=2021-11-23 18:40:20&pageSize=5&beginTime=2020-11-24 18:40:20")
                        .header("authorization", token)
                        .exchange()
                        .expectStatus().isOk()
                        .expectBody()
...
//    }
    ...
    public void getOrders6() throws Exception {
        String token = this.userLogin("8606245097", "123456");
        byte[] responseString =
                mallClient.get().uri("payment/orders?page=1&pageSize=5&beginTime=2020-11-2418:40:20")
                        .header("authorization", token)
                        .exchange()
                        .expectStatus().isBadRequest()
                        .expectBody()
